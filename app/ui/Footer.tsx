        ...
        <div className={`${className} bg-background-footer text-white font-bold`}>
            ...
            <div className="flex flex-col gap-6 text-center w-full py-8 md:ml-20 lg:ml-32" >
                <div className="flex gap-2" >
                    <Image src={map_icon.src} width={width < 800 ? 20 : 30} height={width < 800 ? 20 : 30} alt="Ícone de Pino de Mapa" />
                ...
                <div className="flex gap-4" >
                    <Image src={phone_icon.src} width={width < 800 ? 20 : 30} height={width < 800 ? 20 : 30} alt="Ícone de Pino de Mapa" />
                    <div className="text-start text-[2cqw] md:text-lg" >
                        <p>(47) 99962-6217</p>
                    </div>
                </div>
                ...
                <div className="flex gap-4" >
                    <Image src={instagram_icon.src} width={width < 800 ? 20 : 30} height={width < 800 ? 20 : 30} alt="Ícone de Pino de Mapa" />
                    <div className="text-start text-[2cqw] md:text-lg" >
                        <p>aeroplano_design</p>
                    </div>
                </div>
                <div className="flex gap-4" >
                    <Image src={email_icon.src} width={width < 800 ? 20 : 30} height={width < 800 ? 20 : 30} alt="Ícone de Pino de Mapa" />
                    <div className="text-start text-[2cqw] md:text-lg" >
